...
A 2026 systematic review/meta-analysis restricted to technology-based randomized trials found only 7 studies / 580 participants and did **not** find reliable evidence that technology-only approaches reduce loneliness. Earlier RCT-only evidence in older adults likewise found little-to-no difference versus controls. Technology should therefore be treated as a delivery tool or complement unless a target population has direct evidence for the specific digital pathway; scalability alone is not evidence of effect.
...
- **Moderate-high confidence:** digital-only intervention evidence is too weak/uncertain to justify assuming that technological scalability preserves effectiveness.
